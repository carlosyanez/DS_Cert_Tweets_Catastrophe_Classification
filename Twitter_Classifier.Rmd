...
p<- training_tokenised$tokenised_words %>% group_by(word) %>%
  ...
  labs(title="Pos. and neg. ccurrences for each word (log scale)",y="Positives", x = "Negatives") +
  theme_grey() +
...
results_1$results_extended %>% filter(category == "FP")  %>%
  ...
  filter(id %in% c(269,3581,1026,9779,10380,10402)) %>%
...
results_1$results_extended %>% filter(category == "FN")  %>%
  select(id,target,original_text)  %>%
  filter(id %in% c(3,253,1172,1968,6571)) %>%
